...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='em_user', help='Path to the dataset')
    ...
    for kappa in kappas:
        ...
        for num_edge in num_edges:
            ...
            for gamma in gammas:
                ...
                for knn in knns:
                    args.knn = knn
                    print(f"KNN: {args.knn}, swith_epoch: {args.swtich_epoch}, gamma: {args.gamma}, kappa: {args.kappa}")
                    run_helper(args)
                    print('\n')
